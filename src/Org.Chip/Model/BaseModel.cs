...
namespace Org.Chip.Model
{
    ...
    public partial class BaseModel : IEquatable<BaseModel>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BaseModel);
        }

        /// <summary>
        /// Returns true if BaseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseModel input)
        {
            if (input == null)
                return false;
