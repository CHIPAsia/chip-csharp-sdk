...
namespace Org.Chip.Model
{
    ...
    public partial class InlineResponse2001 : IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(List<BillingTemplate> results = default(List<BillingTemplate>), string next = default(string), string previous = default(string))
        {
        ...
        public List<BillingTemplate> Results { get; set; }
