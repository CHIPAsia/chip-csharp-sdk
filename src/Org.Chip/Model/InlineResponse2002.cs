...
namespace Org.Chip.Model
{
    ...
    public partial class InlineResponse2002 : IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        public InlineResponse2002(List<BillingTemplateClient> results = default(List<BillingTemplateClient>), string next = default(string), string previous = default(string))
        {
        ...
        public List<BillingTemplateClient> Results { get; set; }
