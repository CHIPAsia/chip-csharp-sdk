...
namespace Org.Chip.Client
{
    ...
    public class ApiResponse<T> : IApiResponse
    {
        ...
        public RestSharp.IRestRequest RestRequest { get; }
        ...
        public ApiResponse(HttpStatusCode statusCode, Multimap<string, string> headers, T data, string rawContent, RestSharp.IRestRequest restRequest)
        {
